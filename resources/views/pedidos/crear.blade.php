    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-header">
                ...
                <h4 class="modal-title">Pedido nuevo</h4>
            </div>
                ...
                <div class="form-group">
                    <div class="row">
                        <div class="col-xs-9">
                            ...
                            <select id="select_platos" name="select_platos" class="form-control">
                        ...
                        <div class="col-xs-3">
                            {!! Form::label('id_plato', 'Código') !!}
                            {!! Form::number('id_plato', null, ['class' => 'form-control', 'placeholder' => 'Código',]) !!}
                        </div>
                    </div>
                </div>
                <div class="form-group">
                    <button id="add-plato" class="btn btn-default btn-block btn-lg">Añadir</button>
                </div>
                <hr>
